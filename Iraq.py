...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('هنا يمك العراق ابشر @OM0OM  ')
...
async def _(event):
        ...
        await sython.send_message('@zmmbot', 'جاري التجميع بواسطة |IRAQ TEAM')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
        ...
        await sython.send_message('@A_MAN9300BOT', 'جاري التجميع بواسطة |IRAQ TEAM')
        channel_entity = await sython.get_entity(bot_usernamee)
...
async def _(event):
      await event.reply("""السـورس يعمـل |العراق
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
